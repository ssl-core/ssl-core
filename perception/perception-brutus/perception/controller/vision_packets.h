...
// TODO(#ISSUE_N): using TrackedPacket = protocols::third_party::game_controller::TrackedWrapper;
using PacketVariant = std::variant<RawPacket>;
...
class VisionPackets {
 ...
 private:
  ...
  // TODO(#ISSUE_N): Add std::vector<TrackedPacket> tracked_packets_;
