#ifndef PERCEPTION_DETECTION_CONVERTER_RAW_DETECTION_H
#define PERCEPTION_DETECTION_CONVERTER_RAW_DETECTION_H

#include "perception/raw_detection/entities/raw_ball.h"
...
#endif // PERCEPTION_DETECTION_CONVERTER_RAW_DETECTION_H
