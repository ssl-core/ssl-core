#ifndef PERCEPTION_RAW_DETECTION_ENTITIES_RAW_ROBOT_H
#define PERCEPTION_RAW_DETECTION_ENTITIES_RAW_ROBOT_H

#include "perception/raw_detection/entities/point.h"
...
#endif // PERCEPTION_RAW_DETECTION_ENTITIES_RAW_ROBOT_H
