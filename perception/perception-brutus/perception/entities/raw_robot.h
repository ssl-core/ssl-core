#ifndef PERCEPTION_ENTITIES_RAW_ROBOT_H
#define PERCEPTION_ENTITIES_RAW_ROBOT_H

#include "perception/entities/point.h"
#include "perception/entities/robot_id.h"
...
#endif // PERCEPTION_ENTITIES_RAW_ROBOT_H
