...
class TestCommunicationManager extends BaseCommunicationManager {
  ...
  private createDefaultFrame(): Frame {
    ...
    return {
      ...
      homeTeam: {
        ...
        goalkeeperId: 0,
        yellowCards: 0,
        timeToExpireActiveYellowCards: [],
        redCards: 0,
        timeoutsLeft: 4,
        totalTimeoutTimeLeft: new Date(300000000000),
        foulsCommitted: 0,
        consecutiveBallPlacementFailures: 0,
        isBallPlacementEnabled: true,
        hasBallPlacementFailuresReachedMaximum: false,
        maximumAllowedRobots: 11,
        isRobotSubstitutionRequested: false,
        isRobotSubstitutionAllowed: false,
        robotSubstitutionsLeft: 0,
        robotSubstitutionTimeLeft: new Date(0),
      },
      awayTeam: {
        name: "Other team",
        score: 0,
      ...
      gameStage: "GAME_STAGE_NORMAL_FIRST_HALF_PRE",
      gameStageTimeLeft: new Date(300000000000),
      totalCommands: 0,
      commandTime: new Date(0),
      command: {
        Command: {
          Halt: {},
        },
  ...
  private handleFrame(frame: Frame) {
    this.appChannel.postMessage(frame);
  }
}

export default TestCommunicationManager;
