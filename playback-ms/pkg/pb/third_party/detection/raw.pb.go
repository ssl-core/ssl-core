...
func (x *SSL_DetectionBall) Reset() {
	*x = SSL_DetectionBall{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protocols_third_party_detection_raw_proto_msgTypes[0]
...
func (*SSL_DetectionBall) Descriptor() ([]byte, []int) {
	return file_protocols_third_party_detection_raw_proto_rawDescGZIP(), []int{0}
}
...
func (x *SSL_DetectionRobot) Reset() {
	*x = SSL_DetectionRobot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protocols_third_party_detection_raw_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SSL_DetectionRobot) Descriptor() ([]byte, []int) {
	return file_protocols_third_party_detection_raw_proto_rawDescGZIP(), []int{1}
}
...
func (x *SSL_DetectionFrame) Reset() {
	*x = SSL_DetectionFrame{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protocols_third_party_detection_raw_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SSL_DetectionFrame) Descriptor() ([]byte, []int) {
	return file_protocols_third_party_detection_raw_proto_rawDescGZIP(), []int{2}
}
...
var File_protocols_third_party_detection_raw_proto protoreflect.FileDescriptor

var file_protocols_third_party_detection_raw_proto_rawDesc = []byte{
	0x0a, 0x29, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2f, 0x74, 0x68, 0x69, 0x72,
	0x64, 0x5f, 0x70, 0x61, 0x72, 0x74, 0x79, 0x2f, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x2f, 0x72, 0x61, 0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2e, 0x74, 0x68, 0x69, 0x72, 0x64, 0x5f, 0x70, 0x61, 0x72,
	0x74, 0x79, 0x2e, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa3, 0x01, 0x0a,
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xac, 0x03, 0x0a,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x53, 0x4c, 0x5f, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x6f, 0x62, 0x6f, 0x74, 0x52, 0x0c, 0x72, 0x6f, 0x62, 0x6f, 0x74, 0x73, 0x59,
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x12, 0x54, 0x0a, 0x0b, 0x72, 0x6f, 0x62, 0x6f, 0x74, 0x73, 0x5f,
	0x62, 0x6c, 0x75, 0x65, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2e, 0x74, 0x68, 0x69, 0x72, 0x64, 0x5f, 0x70, 0x61, 0x72,
	0x74, 0x79, 0x2e, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x53, 0x4c,
	0x5f, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x6f, 0x62, 0x6f, 0x74, 0x52,
	0x0a, 0x72, 0x6f, 0x62, 0x6f, 0x74, 0x73, 0x42, 0x6c, 0x75, 0x65,
}

var (
	file_protocols_third_party_detection_raw_proto_rawDescOnce sync.Once
	file_protocols_third_party_detection_raw_proto_rawDescData = file_protocols_third_party_detection_raw_proto_rawDesc
)

func file_protocols_third_party_detection_raw_proto_rawDescGZIP() []byte {
	file_protocols_third_party_detection_raw_proto_rawDescOnce.Do(func() {
		file_protocols_third_party_detection_raw_proto_rawDescData = protoimpl.X.CompressGZIP(file_protocols_third_party_detection_raw_proto_rawDescData)
	})
	return file_protocols_third_party_detection_raw_proto_rawDescData
}

var file_protocols_third_party_detection_raw_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protocols_third_party_detection_raw_proto_goTypes = []interface{}{
	(*SSL_DetectionBall)(nil),  // 0: protocols.third_party.detection.SSL_DetectionBall
	(*SSL_DetectionRobot)(nil), // 1: protocols.third_party.detection.SSL_DetectionRobot
	(*SSL_DetectionFrame)(nil), // 2: protocols.third_party.detection.SSL_DetectionFrame
}
var file_protocols_third_party_detection_raw_proto_depIdxs = []int32{
	0, // 0: protocols.third_party.detection.SSL_DetectionFrame.balls:type_name -> protocols.third_party.detection.SSL_DetectionBall
	1, // 1: protocols.third_party.detection.SSL_DetectionFrame.robots_yellow:type_name -> protocols.third_party.detection.SSL_DetectionRobot
	1, // 2: protocols.third_party.detection.SSL_DetectionFrame.robots_blue:type_name -> protocols.third_party.detection.SSL_DetectionRobot
...
func init() { file_protocols_third_party_detection_raw_proto_init() }
func file_protocols_third_party_detection_raw_proto_init() {
	if File_protocols_third_party_detection_raw_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_protocols_third_party_detection_raw_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protocols_third_party_detection_raw_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protocols_third_party_detection_raw_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protocols_third_party_detection_raw_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_protocols_third_party_detection_raw_proto_goTypes,
		DependencyIndexes: file_protocols_third_party_detection_raw_proto_depIdxs,
		MessageInfos:      file_protocols_third_party_detection_raw_proto_msgTypes,
	}.Build()
	File_protocols_third_party_detection_raw_proto = out.File
	file_protocols_third_party_detection_raw_proto_rawDesc = nil
	file_protocols_third_party_detection_raw_proto_goTypes = nil
	file_protocols_third_party_detection_raw_proto_depIdxs = nil
}
